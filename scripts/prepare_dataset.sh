...
OUTPUT_PATH="/workspace/data1/dataset/ablation/instruction_compare/scalevln_event060_bg011_tail050_5k_ep.jsonl"
...
MAX_EPISODES_PER_SUBSET="5000"  # 随机选取的源episode数量；留空表示使用全部episode。
