...
from unik3d.models.backbones import _make_dinov2_model
...
def swin2_tiny(
    ...
    **kwargs,
    ...
    from unik3d.models.backbones import SwinTransformerV2
...
def convnextv2_base(config, **kwargs):
    from unik3d.models.backbones import ConvNeXtV2
...
def convnext_large(config, **kwargs):
    from unik3d.models.backbones import ConvNeXt
