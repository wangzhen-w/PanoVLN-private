...
class TrainingConfig:
    output_dir: str = "/workspace/data1/model/panoworld/panovln_panovggt_1e-6"
...
def _resolve_config_paths(cfg: TrainConfig) -> TrainConfig:
    ...
    cfg.model.panovggt_checkpoint_path = _resolve_path(
        cfg.model.panovggt_checkpoint_path,
        config_dir,
    )
