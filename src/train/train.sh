...
OUTPUT_DIR="/workspace/data2/model/ablation_new/panovggt_pre_merger/panovggt_0.20_lr2e-5_singlepoint_8card"
...
if (( $# != 0 )); then
    echo "The controlled FDS+IDS launcher does not accept overrides: $*" >&2
    exit 1
fi
