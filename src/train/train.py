...
def print_training_config(cfg) -> None:
    ...
    rank0_print(RANK, f"action_calibrator_alpha_init: {_config_value(cfg.model.action_calibrator_alpha_init)}")
    rank0_print(RANK, f"action_calibrator_alpha_max: {_config_value(cfg.model.action_calibrator_alpha_max)}")
